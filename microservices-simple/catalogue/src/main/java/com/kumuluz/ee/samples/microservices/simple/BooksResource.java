...
public class BooksResource {
	...
	/**
	 * <p>
	 * Queries the database and returns a list of all books.
	 * </p>
	 *
	 * @return Response object containing the retrieved list of books from the
	 *         database.
	 */
	@GET
	...
	/**
	 * <p>
	 * Queries the database and returns a specific book based on the given id.
	 * </p>
	 *
	 * @param id The id of the wanted book.
	 * @return Response object containing the requested book, or empty with the
	 *         NOT_FOUND status.
	 */
	@GET
	@Path("/{id}")
	...
	public Response createBook(Book b) {
		...
		return Response.status(Response.Status.CREATED).entity(toUse).build();
	}
